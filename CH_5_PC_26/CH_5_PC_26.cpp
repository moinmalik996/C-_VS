// CH_5_PC_26.cpp : Using Files - Savings Account Balance Modification
...
int main()
{
    ...
    if (current_balance > 0) {
        ...
        myreport << current_balance << endl;
        myreport << total_amount_deposited << endl;
        myreport << total_amount_withdraw << endl;
        myreport << total_interest_earned << endl;
